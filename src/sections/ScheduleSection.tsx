 ...
 * guess would have.
 *
 * Declared bottom-to-top; DOM order is the stacking order. Only the actual schedule text
 * (lead-in/date/akad/resepsi) animates in — the card frame, garland, house and foliage are
