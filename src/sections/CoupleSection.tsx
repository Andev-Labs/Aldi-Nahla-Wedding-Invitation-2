...
const LAYERS = [
  ...
  { asset: 27, key: 'trim-top', src: '/assets/section-04/trim-top.webp', x: 338, y: -3, width: 6450, height: 417, variant: undefined },
  { asset: 38, key: 'trim-bottom', src: '/assets/section-04/trim-bottom.webp', x: 294, y: 1868, width: 6450, height: 417, variant: undefined },
  { asset: 26, key: 'curtain-left', src: '/assets/section-04/curtain-left.webp', x: -225, y: -36, width: 2525, height: 4577, variant: undefined },
  { asset: 28, key: 'curtain-right', src: '/assets/section-04/curtain-right.webp', x: 601, y: -27, width: 2749, height: 4449, variant: undefined },
  { asset: 35, key: 'ornament-a', src: '/assets/section-04/ornament-a.webp', x: -614, y: 877, width: 4722, height: 1801, variant: undefined },
  { asset: 36, key: 'ornament-b', src: '/assets/section-04/ornament-b.webp', x: 263, y: 617, width: 7224, height: 2756, variant: undefined },
  { asset: 29, key: 'bismillah', src: '/assets/section-04/bismillah.webp', x: 324, y: 273, width: 1722, height: 1389, variant: 'scaleIn' },
  { asset: 30, key: 'name-nahla-karima', src: '/assets/section-04/name-nahla-karima.webp', x: 325, y: 661, width: 1723, height: 1223, variant: 'fadeUp' },
  { asset: 31, key: 'parents-nahla', src: '/assets/section-04/parents-nahla.webp', x: 242, y: 997, width: 2382, height: 150, variant: 'fadeUp' },
  { asset: 32, key: 'dengan', src: '/assets/section-04/dengan.webp', x: 482, y: 1078, width: 464, height: 102, variant: 'fadeIn' },
  { asset: 33, key: 'name-aldi-ramadhan', src: '/assets/section-04/name-aldi-ramadhan.webp', x: 269, y: 1160, width: 2182, height: 937, variant: 'fadeUp' },
  { asset: 34, key: 'parents-aldi', src: '/assets/section-04/parents-aldi.webp', x: 253, y: 1424, width: 2294, height: 150, variant: 'fadeUp' },
