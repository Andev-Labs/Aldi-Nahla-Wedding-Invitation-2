...
const LAYERS = [
  ...
  { asset: 27, key: 'trim-top', src: '/assets/section-04/trim-top.png', x: 338, y: -3, width: 6450, height: 417 },
  { asset: 38, key: 'trim-bottom', src: '/assets/section-04/trim-bottom.png', x: 294, y: 1868, width: 6450, height: 417 },
  { asset: 26, key: 'curtain-left', src: '/assets/section-04/curtain-left.png', x: -225, y: -36, width: 2525, height: 4577 },
  { asset: 28, key: 'curtain-right', src: '/assets/section-04/curtain-right.png', x: 601, y: -27, width: 2749, height: 4449 },
  { asset: 35, key: 'ornament-a', src: '/assets/section-04/ornament-a.png', x: -614, y: 877, width: 4722, height: 1801 },
  { asset: 36, key: 'ornament-b', src: '/assets/section-04/ornament-b.png', x: 263, y: 617, width: 7224, height: 2756 },
  { asset: 29, key: 'bismillah', src: '/assets/section-04/bismillah.png', x: 324, y: 273, width: 1722, height: 1389 },
  { asset: 30, key: 'name-nahla-karima', src: '/assets/section-04/name-nahla-karima.png', x: 325, y: 661, width: 1723, height: 1223 },
  { asset: 31, key: 'parents-nahla', src: '/assets/section-04/parents-nahla.png', x: 242, y: 997, width: 2382, height: 150 },
  { asset: 32, key: 'dengan', src: '/assets/section-04/dengan.png', x: 482, y: 1078, width: 464, height: 102 },
  { asset: 33, key: 'name-aldi-ramadhan', src: '/assets/section-04/name-aldi-ramadhan.png', x: 269, y: 1160, width: 2182, height: 937 },
  { asset: 34, key: 'parents-aldi', src: '/assets/section-04/parents-aldi.png', x: 253, y: 1424, width: 2294, height: 150 },
